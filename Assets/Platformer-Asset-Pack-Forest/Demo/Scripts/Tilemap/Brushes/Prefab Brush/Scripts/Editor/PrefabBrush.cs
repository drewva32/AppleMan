...
namespace UnityEditor
{
    ...
    public class PrefabBrush : UnityEditor.Tilemaps.GridBrush
    {
        ...
        public override void Paint(GridLayout grid, GameObject brushTarget, Vector3Int position)
        {
            ...
            if (instance != null)
            {
                ...
                instance.transform.position = grid.LocalToWorld(grid.CellToLocalInterpolated(new Vector3Int(position.x, position.y, m_Z) + new Vector3(0.5f, 0f, 0.5f) + m_Offset));
            }
        }
    ...
    public class PrefabBrushEditor : UnityEditor.Tilemaps.GridBrushEditor
    {
        ...
        public override void OnPaintInspectorGUI()
        {
            ...
            prefabBrush.m_Offset = EditorGUILayout.Vector3Field("Offset", prefabBrush.m_Offset);

...
public class EnemyWalkState : IState
{
    ...
    {
        _canSeePlayer = Physics2D.Raycast(_StateController.Walkingcontorller.WallCheck.position, _StateController.Walkingcontorller.vectorDirection, _StateController.Walkingcontorller.VisionDistance, _StateController.Walkingcontorller.PlayerLayer);
